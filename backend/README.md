...
## Project Structure
    ...
    ├── shrill_limit_dev_87489  # Django project configurations
...
1. Clone this repo and `cd shrill_limit_dev_87489`
...
2. Clone this repo and `cd shrill_limit_dev_87489`
